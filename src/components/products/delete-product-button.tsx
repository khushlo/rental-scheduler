...
export function DeleteProductButton({ product, onProductDeleted }: DeleteProductButtonProps) {
            ...
            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center">
                  ...
                  <h3 className="text-lg font-medium text-gray-900">Cannot Delete Product</h3>
                </div>
                <button
                  type="button"
                  onClick={handleClose}
              ...
              <div className="mb-4">
                <p className="text-sm text-gray-700 mb-3">
                  This product cannot be deleted because it has active, pending, or confirmed bookings:
                </p>
                ...
                <p className="text-sm text-gray-600 mt-3">
                  Please wait for these bookings to be completed or cancelled before deleting this product.
                </p>
              </div>
            </div>
